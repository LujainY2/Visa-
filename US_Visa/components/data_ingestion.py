...
from US_Visa.entity.config__entity import DataIngestionConfig
from US_Visa.entity.artifact__entity import  DataIngestionArtifact 
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        Output      : Folder is created and train/test files are saved
